# Михаил, не знаю как так выходит, но у меня в скачаевом файле присутствуют все ингредиенты)
# По адресу foodgram-project-react/backend/data вложил свой файл покупок, скриншот корзины, ручной подсчет ингредиентов)
